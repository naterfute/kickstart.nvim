...
require('lazy').setup({
        ...
        gopls = {
          settings = {
            gopls = {
              ...
              staticcheck = true,
              -- Enable golangci-lint integration (assumes it's in your PATH)
          ...
          -- Optional: Run golangci-lint on save for real-time feedback
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter').setup(parsers)
